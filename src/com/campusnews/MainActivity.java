...
public class MainActivity extends BaseActivity implements OnItemClickListener {
  ...
  @AndroidView(R.id.home_menu_header_userpic)
  ImageView home_menu_header_userpic;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    XGPushManager.registerPush(getApplicationContext(), new XGIOperateCallback() {
      ...
      public void onFail(Object data, int errCode, String msg) {
        Log.w(Constants.LogTag, "+++ register push fail. token:" + data + ", errCode:" + errCode
            + ",msg:" + msg);
  ...
  public void initView() {
    UserInfo.isNews = 0;
//    if (BaseApplication.accountData.icon!=null) {
//      LoadingImage.loadImage(this, home_menu_header_userpic, StaticUrl.baseImageUlr
//          + BaseApplication.accountData.icon, UserInfo.isNews);
//    }
    ...
    /*
     * set the shadow for drawer at start(left) or end(right)设置drawerLayout侧滑方式（左向右或右向左）
     */
    ...
    /*
     * set the application ActionBar title changes 监听DrawerLayout打开关闭的状态，用来设置标题
     */
    mDrawerToggle =
  ...
  @Override
  public void onItemClick(AdapterView<?> arg0, View container, int point, long arg3) {
    creatFragment(point);
  }

  // 创建菜单栏的fragment
  public void creatFragment(int point) {
    Toast.makeText(this, "菜单第" + point + "个item", Toast.LENGTH_SHORT).show();
